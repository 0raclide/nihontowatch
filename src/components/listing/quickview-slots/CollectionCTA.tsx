...
export function CollectionCTA({ collectionItem, onEditCollection, onPromoted }: CollectionCTAProps) {
  const { t } = useLocale();
    ...
    <div className="space-y-2">
      <div className="flex gap-2">
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 px-5 py-3 text-[15px] font-medium text-white bg-gold hover:bg-gold-light rounded-lg transition-colors"
        >
        ...
        {collectionItem?.source_listing_id && (
          <a
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 text-[15px] font-medium text-charcoal bg-linen hover:bg-hover border border-border rounded-lg transition-colors"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
