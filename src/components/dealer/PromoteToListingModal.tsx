...
export function PromoteToListingModal({
  isOpen,
  onClose,
  collectionItemId,
  currentPrice,
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      const res = await fetch(`/api/collection/items/${collectionItemId}/promote`, {
        method: 'POST',
  ...
  }, [canSubmit, collectionItemId, isAsk, priceValue, priceCurrency, onSuccess, onClose]);
