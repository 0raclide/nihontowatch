        ...
        {displayHeadline && (
          editable && onHeadlineSave ? (
            <EditableText
              ...
              className="text-center font-serif text-[16px] md:text-[18px] leading-[1.7] italic text-charcoal mb-4"
              placeholder="Add headline..."
            >
              <p className="text-center font-serif text-[16px] md:text-[18px] leading-[1.7] italic text-charcoal mb-4">
                {displayHeadline}
              </p>
            </EditableText>
          ) : (
