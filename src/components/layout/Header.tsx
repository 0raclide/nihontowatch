                  ...
                  <div ref={adminMenuRef} className="relative">
                    ...
                    {showAdminMenu && (
                      <div className="absolute right-0 mt-2 w-48 bg-cream rounded-lg shadow-lg border border-border py-1 z-50 animate-fadeIn">
                        <button
                          onClick={() => { setShowAdminMenu(false); window.location.href = '/admin'; }}
                        ...
                        <button
                          onClick={() => { setShowAdminMenu(false); window.location.href = '/admin/users'; }}
                          className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-muted hover:text-ink hover:bg-hover transition-colors text-left"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                          onClick={() => { setShowAdminMenu(false); window.location.href = '/admin/activity'; }}
                          className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-muted hover:text-ink hover:bg-hover transition-colors text-left"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                          onClick={() => { setShowAdminMenu(false); window.location.href = '/admin/analytics'; }}
                          className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-muted hover:text-ink hover:bg-hover transition-colors text-left"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                          onClick={() => { setShowAdminMenu(false); window.location.href = '/admin/alerts'; }}
                          className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-muted hover:text-ink hover:bg-hover transition-colors text-left"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
