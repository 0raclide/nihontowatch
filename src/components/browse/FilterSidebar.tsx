  ...
  return (
    <label className="flex items-center gap-2.5 cursor-pointer group py-1">
      <div className="relative">
        ...
        />
        <div className="w-3.5 h-3.5 border border-border-dark dark:border-gray-600 peer-checked:border-gold peer-checked:bg-gold transition-colors rounded-sm">
          {checked && (
            <svg className="w-3.5 h-3.5 text-white dark:text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="inline-flex bg-linen dark:bg-gray-800/50 p-0.5 rounded-sm">
              {[
                ...
                <button
                  ...
                  className={`px-3 py-1.5 text-[11px] tracking-wide transition-all duration-200 ${
          ...
          <div className="py-5">
            ...
            <div className="relative">
              <button
                ...
                className="w-full flex items-center justify-between px-3 py-2 bg-white dark:bg-gray-800/50 border border-border dark:border-gray-700 text-left text-[13px] text-charcoal dark:text-gray-300 hover:border-border-dark dark:hover:border-gray-600 transition-colors"
              >
                ...
                <div className="absolute z-20 top-full left-0 right-0 mt-1 bg-white dark:bg-gray-800 border border-border dark:border-gray-700 shadow-lg max-h-64 overflow-hidden">
                  ...
                  <div className="p-2 border-b border-border/50 dark:border-gray-700/50">
                    <input
                      ...
                      className="w-full px-2 py-1.5 text-[12px] bg-linen dark:bg-gray-900 border-0 text-ink dark:text-white placeholder:text-muted/60 focus:outline-none focus:ring-1 focus:ring-gold/50"
                    />
                  </div>
                  {/* Dealer list */}
                  <div className="max-h-48 overflow-y-auto py-1">
                    {filteredDealers.map((dealer) => (
                      <label
                        key={dealer.id}
                        className="flex items-center gap-2 px-3 py-1.5 cursor-pointer hover:bg-linen dark:hover:bg-gray-700/50 transition-colors"
                      >
                        <input
                          type="checkbox"
                        ...
                        />
                        <div className="w-3 h-3 border border-border-dark dark:border-gray-600 peer-checked:border-gold peer-checked:bg-gold transition-colors rounded-sm flex items-center justify-center">
                          {filters.dealers.includes(dealer.id) && (
                            <svg className="w-2.5 h-2.5 text-white dark:text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
