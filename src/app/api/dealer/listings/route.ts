...
export async function POST(request: NextRequest) {
  ...
  const listingData: Record<string, unknown> = {
    ...
    ai_curator_headline_ja: ai_curator_headline_ja ?? null,
