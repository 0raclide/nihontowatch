...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      console.error('[collection/catalog-match] RPC error:', error);
    ...
    // Transform items: build all candidate image URLs
    ...
    console.error('[collection/catalog-match] Unexpected error:', err);
