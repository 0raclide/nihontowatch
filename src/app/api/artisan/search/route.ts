...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    let makersQuery = yuhinkaiClient
      .from('artisan_makers')
      .select('maker_id, name_romaji, name_kanji, name_romaji_normalized, display_name, legacy_school_text, artisan_schools(name_romaji), province, era, generation, domain, hawley, fujishiro, elite_factor, kokuho_count, juyo_count, tokuju_count, total_items, teacher_text, period')
    ...
    let schoolsQuery = yuhinkaiClient
      ...
      .select('school_id, name_romaji, name_kanji, domain, tradition, province, era_start, era_end, characteristics, elite_factor, kokuho_count, juyo_count, tokuju_count, total_items')
