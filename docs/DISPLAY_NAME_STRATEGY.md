...
| `YOS1434` | Gō Yoshihiro | Yoshihiro | Sōshū Gō | "Gō Yoshihiro" is the collector-standard name; "Soshu Gō Yoshihiro" confuses with Soshu Yoshihiro (a different smith) |
...
| 2026-02-25 | Added YOS1434 alias | Gō Yoshihiro | Alias — "Sōshū Gō Yoshihiro" → "Gō Yoshihiro" (user report: confuses with Soshu Yoshihiro) |
